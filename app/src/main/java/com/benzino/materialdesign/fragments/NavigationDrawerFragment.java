...
import com.benzino.materialdesign.pojo.Data;
import com.benzino.materialdesign.R;
import com.benzino.materialdesign.adapters.Adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final GestureDetector mGestureDetector = new GestureDetector(getActivity(), new GestureDetector.SimpleOnGestureListener() {
            ...
            public void onLongPress(MotionEvent e) {
                super.onLongPress(e);
                Log.d("ANAS", ">>>>>>>>>>>onLongPress ");
                View child = recyclerView.findChildViewUnder(e.getX(), e.getY());
                Toast.makeText(getActivity(), "onLongClick"+ recyclerView.getChildPosition(child), Toast.LENGTH_SHORT).show();
            }
        });
